...
impl From<proto::CryptoAddClaim::Claim> for Claim {
    fn from(mut claim: proto::CryptoAddClaim::Claim) -> Self {
        Self {
...
pub struct QueryCryptoGetInfoAnswer {
    pub account_id: AccountId,
    ...
    pub generate_receive_record_theshold: u64,
...
impl From<proto::CryptoGetInfo::CryptoGetInfoResponse_AccountInfo> for QueryCryptoGetInfoAnswer {
    fn from(mut info: proto::CryptoGetInfo::CryptoGetInfoResponse_AccountInfo) -> Self {
        Self {
            ...
            key: info.take_key().try_into().unwrap(),
            ...
            receiver_sig_required: info.get_receiverSigRequired(),
...
impl Query<QueryCryptoGetInfoAnswer> {
    pub fn get_account_info(client: &Client, account: AccountId) -> Self {
        Self::new(client, QueryCryptoGetInfo { account })
    }
}

impl QueryInner for QueryCryptoGetInfo {
    type Response = QueryCryptoGetInfoAnswer;
    ...
    fn get(&self, mut response: proto::Response::Response) -> Result<Self::Response, Error> {
        ...
        match header.get_nodeTransactionPrecheckCode().into() {
            PreCheckCode::Ok => Ok(response.take_accountInfo().into()),
