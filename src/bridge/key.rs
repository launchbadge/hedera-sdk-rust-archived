...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn hedera_signature_to_str(p: *mut Signature) -> *mut c_char {
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn hedera_signature_from_str(s: *const c_char, out: *mut Signature) -> u64 {
...
#[doc(hidden)]
#[no_mangle]
pub unsafe extern "C" fn hedera_public_key_verify(p: *mut PublicKey, s: *mut Signature, message: *const u8, message_len: usize, out: *mut i8) -> u64 {
    debug_assert!(!s.is_null());
    debug_assert!(!message.is_null());
    debug_assert!(!p.is_null());
    debug_assert!(!out.is_null());
